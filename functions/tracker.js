export async function onRequestPost(context) {
  ...
  try {
    ...
    // Cookie is the primary source. Fallback to body.session_id for
    // server-to-server callers (e.g. /api/lead.ts on the quiz subdomain
    // which can't forward the visitor's _krob_sid cookie cross-origin).
    let sessionData = {};
